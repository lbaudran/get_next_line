...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/01/12 12:57:28 by lbaudran          #+#    #+#             */
/*   Updated: 2016/05/13 15:40:47 by lbaudran         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char		**alloc_str(t_list *elem, char **str, char *buf)
{
	int		i;
	int		n;
	char	*buffer;
...
static t_list	*create_node(t_list *begin, int fd)
{
	t_list *elem;
...
static int		stock_rest(t_list *elem, char **str, char *buf)
{
	int i;
...
static int		stock_buf(t_list *elem, char *buf, char **str)
{
	int i;
	int n;
